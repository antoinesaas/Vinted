...
export default function CalculateurScreen() {
  ...
  // l'acheteur inclut en plus les frais acheteur (protection + livraison,
  // 5 € forfaitaires) : c'est ce coût total qui sert de base au calcul
  ...
  const purchaseRange = useMemo(() => {
    ...
    const toDisplayed = (n: number) =>
      Math.max(0, Math.round((n - BUYER_FEES_TOTAL) * 100) / 100);
    return {
